                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form action="{{ url('admin/login_store') }}" method="post" class="row g-3">
											{{ csrf_field() }}
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Email Address</label>
                                                <input type="email" class="form-control" id="inputEmailAddress"
                                                    placeholder="Email Address" name="email" value="admin@email.com">
                                            </div>
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0"
                                                        id="inputChoosePassword" value="123546"
