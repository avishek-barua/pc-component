                            ...
                            <div class="product-layout col-lg-15 col-md-4 col-sm-6 col-xs-12">
                                <div class="product-item-container">
                                    <div class="left-block left-b">
                                        ...
                                        <div class="product-image-container second_img">
                                            <a href="{{ url('product_details') }}" target="_self"
                                                title="Lastrami bacon">
                                                <img src="{{ asset('frontend') }}/image/catalog/demo/product/270/e1.jpg"
                                                    class="img-1 img-responsive" alt="image1">
                                                <img src="{{ asset('frontend') }}/image/catalog/demo/product/270/e10.jpg"
                                                    class="img-2 img-responsive" alt="image2">
                                            </a>
                                        </div>
